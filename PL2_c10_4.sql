...
DROP INDEX IF EXISTS idx_clientes_provincia_hash;
DROP INDEX IF EXISTS idx_reserva_reservaid_hash;
DROP INDEX IF EXISTS idx_reservas_fechainicio_hash;
DROP INDEX IF EXISTS idx_reservas_fechafin_hash;
DROP INDEX IF EXISTS idx_pagos_cantidad_hash;
DROP INDEX IF EXISTS idx_plazas_nivel_hash;
DROP INDEX IF EXISTS idx_incidencias_reservaid_hash;
